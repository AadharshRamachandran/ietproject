...
def run_server(
    ...
    **kwargs
    ...
    logger.info(f"â³ Waiting for gRPC server to bind on port {port}¦")
    ...
    logger.info(f"âœ… gRPC server confirmed up on port {port}, published server_ready")
    ...
    logger.info("âœ… FL training complete.")
